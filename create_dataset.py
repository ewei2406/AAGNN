...
def process_raw_pokec():
    ...
    node_attributes.to_csv('./pokec/pokec2_node_attribute.csv', sep=',', index=False)
    node_features.to_csv('./pokec/pokec2_node_feature.csv', sep=',', index=False)
    node_labels.to_csv('./pokec/pokec2_node_label.csv', sep=',', index=False)
    edges.to_csv('./pokec/pokec2_edge.csv', sep=',', index=False)
